...
import it.univaq.f4i.iw.ex.newspaper.data.dao.RichiestaOrdineDAO;
import it.univaq.f4i.iw.ex.newspaper.data.model.RichiestaOrdine;
import it.univaq.f4i.iw.ex.newspaper.data.model.impl.StatoRichiesta;
import it.univaq.f4i.iw.ex.newspaper.data.model.impl.proxy.RichiestaOrdineProxy;
