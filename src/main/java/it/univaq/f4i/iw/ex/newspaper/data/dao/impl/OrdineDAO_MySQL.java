...
import it.univaq.f4i.iw.ex.newspaper.data.dao.OrdineDAO;
import it.univaq.f4i.iw.ex.newspaper.data.model.Ordine;
import it.univaq.f4i.iw.ex.newspaper.data.model.impl.StatoOrdine;
import it.univaq.f4i.iw.ex.newspaper.data.model.impl.proxy.OrdineProxy;
