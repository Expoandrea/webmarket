...
import it.univaq.f4i.iw.ex.newspaper.data.dao.PropostaAcquistoDAO;
import it.univaq.f4i.iw.ex.newspaper.data.model.PropostaAcquisto;
import it.univaq.f4i.iw.ex.newspaper.data.model.impl.StatoProposta;
import it.univaq.f4i.iw.ex.newspaper.data.model.impl.proxy.PropostaAcquistoProxy;
